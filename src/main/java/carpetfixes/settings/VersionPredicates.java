...
public class VersionPredicates {
    public final static String LT_1_18_2_pre1 = "<1.18.2-pre1"; //Less Than 1.18.2-pre2
    public final static String LT_22w07a = "<1.18.2-alpha.22.7.a"; //Less Than 22w07a
    public final static String GT_22w06a = ">1.18.2-alpha.22.6.a"; //Greater Than 22w06a
